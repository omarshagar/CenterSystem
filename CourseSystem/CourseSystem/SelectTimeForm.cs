    ...
    public partial class SelectTimeForm : Form
    {
        ...
        private void save_btn_Click(object sender, EventArgs e)
        {
            ...
            finally
            {
                ...
                //int numofsess = hs.Count;
                //OracleCommand cmd = new OracleCommand();
                //conn.Open();
                //cmd.Connection = conn;
                //cmd.CommandText = "update instructor set balance = (instructor.balance - :newbal) where instructor_id = :id";
                //cmd.CommandType = CommandType.Text;
                //cmd.Parameters.Add("newbal", numofsess * 10);
                //cmd.Parameters.Add("id", this.instructor);
