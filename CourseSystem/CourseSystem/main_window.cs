...
namespace CourseSystem
{
    public partial class main_form : Form
    {
            ...
            */
            ...
            for (int i = 0; i < listItems.Length; i++)
            {
                ...
                */
                ...
                cmd2.Connection = con;
                cmd2.CommandText = "select firstname,lastname from instructor where instrcutor_id=:numb";
                ...
                listItems[i].Message ="Dr:"+dt2.Rows[0][0].ToString()+'_'+ dt2.Rows[0][1].ToString();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            courses_not_enrollment_form co = new courses_not_enrollment_form();
            co.Show();
        }
